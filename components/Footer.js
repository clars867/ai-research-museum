...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-t from-parchment to-white py-6 px-6 border-t border-gray-200">
      <div className="max-w-5xl mx-auto flex justify-between items-center text-sm text-gray-600">
        ...
        <div className="space-x-4">
          <Link href="/meet-the-founder">
            <span className="hover:text-mystic cursor-pointer">Meet the Founder</span>
          </Link>
          <a
            href="https://github.com/clars867"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-mystic"
          >
            GitHub
          </a>
        </div>
